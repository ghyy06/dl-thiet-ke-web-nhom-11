...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // THÊM MỚI: XỬ LÝ CLICK VÉ VÀNG HIỆN MÃ GIẢM GIÁ
    const ticketBtn = document.getElementById("ticket-btn");
    const promoCodes = document.getElementById("promo-codes");

    if (ticketBtn !== null && promoCodes !== null) {
        ticketBtn.addEventListener("click", function() {
            if (promoCodes.style.display === "none" || promoCodes.style.display === "") {
                promoCodes.style.display = "flex";
            } else {
                promoCodes.style.display = "none";
            }
        });
    }
